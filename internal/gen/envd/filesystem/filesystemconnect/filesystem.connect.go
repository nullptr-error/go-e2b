...
import (
	...
	context "context"
	errors "errors"
	filesystem "github.com/matiasinsaurralde/go-e2b/internal/gen/envd/filesystem"
	http "net/http"
	strings "strings"
)
...
func NewFilesystemClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FilesystemClient {
	...
	filesystemMethods := filesystem.File_envd_filesystem_filesystem_proto.Services().ByName("Filesystem").Methods()
